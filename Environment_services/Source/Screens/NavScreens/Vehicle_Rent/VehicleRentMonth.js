...
const DottedCircle = () => (
  <View style={{flexDirection: 'row', justifyContent: 'center'}}>
    ...
    <View style={{position: 'absolute', paddingTop: 40}}>
  ...
  return (
    <ScrollView>
      <View style={NormalStyles.CardContainer2}>
        <Text style={CollectionStyles.HeaderText}>Corporate Vehicles-Month</Text>
      ...
      <View style={NormalStyles.CardContainer2}>
        <Text style={CollectionStyles.HeaderText}>Vendor Vehicles-Month</Text>
        <View style={CollectionStyles.PieContainer}>
          <PieChart
            data={Seconddata}
            showText
