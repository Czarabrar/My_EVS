...
import VehicleRentToday from './Vehicle_Rent/VehicleRentToday';
import VehicleRentWeek from './Vehicle_Rent/VehicleRentWeek';
import VehicleRentMonth from './Vehicle_Rent/VehicleRentMonth';
...
const VehicleRent = () => {
  ...
  const renderselect = () => {
      switch (selectedTitle) {
        case 'Today':
          return <VehicleRentToday/>
        case 'Week':
          return <VehicleRentWeek />;
        case 'Month':
          return <VehicleRentMonth />;
