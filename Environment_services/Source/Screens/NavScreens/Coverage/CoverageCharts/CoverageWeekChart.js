...
const CoverageWeekChart = () => {
  const stackData = [
    ...
    {
      stacks: [
        { value: 30000, color: '#90BE6D'},
        { value: 20000, color: '#F94144',borderTopLeftRadius:5 ,borderTopRightRadius:5},
      ],
      label: 'Feb26',
    },
    {
      stacks: [
        ...
        { value: 10000, color: '#F94144',borderTopLeftRadius:5 ,borderTopRightRadius:5},
      ],
      label: 'Feb27',
    },
    {
