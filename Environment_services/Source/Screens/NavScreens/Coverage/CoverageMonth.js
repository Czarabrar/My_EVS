...
const CoverageWeek = () => {
  ...
  return (
    ...
    <View style={NormalStyles.CardContainer}>
      <View style={NormalStyles.CardsvalueContainer}>
        <View style={NormalStyles.TextHeaderContainer1}>
          <Text style={NormalStyles.HeaderText}>D2D HouseHold-Monthly</Text>
        </View>
    ...
    <View style={NormalStyles.CardContainer}>
      <View style={NormalStyles.CardsvalueContainer}>
        <View style={NormalStyles.TextHeaderContainer1}>
          <Text style={NormalStyles.HeaderText}>Sweeping - More Than 6 m-Monthly</Text>
        </View>
        <View style={NormalStyles.TextBodyContainer}>
    ...
    <View style={NormalStyles.CardContainer}>
      <View style={NormalStyles.CardsvalueContainer}>
        <View style={NormalStyles.TextHeaderContainer1}>
          <Text style={NormalStyles.HeaderText}>D2D Commercial Establishment-Monthly</Text>
        </View>
        <View style={NormalStyles.TextBodyContainer}>
    ...
    <View style={NormalStyles.CardContainer}>
      <View style={NormalStyles.CardsvalueContainer}>
        <View style={NormalStyles.TextHeaderContainer1}>
          <Text style={NormalStyles.HeaderText}> Sweeping 5-6m-Monthly</Text>
        </View>
        <View style={NormalStyles.TextBodyContainer}>
